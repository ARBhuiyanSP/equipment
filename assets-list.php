                           ...
                           <div class="col-lg-12">
                                <div class="container">
									...
									<table id="example" class="table table-bordered display" style="width:100%">
										...
										<tbody>
											<?php $results = mysqli_query($db, "SELECT * FROM `assets`"); 
												  while ($row = mysqli_fetch_array($results)) { ?>
										
										
											<tr>
												<td width="200px;"><?php echo $row['name']; ?></td>
												<td width="150px;"><?php echo $row['eel_code']; ?></td>
												<td width="150px;"><?php echo $row['origin']; ?></td>
												<td><?php echo $row['capacity']; ?></td>
												<td><?php echo $row['makeby']; ?></td>
												<td width="200px;"><?php echo $row['model']; ?></td>
												<td>
												<?php 
