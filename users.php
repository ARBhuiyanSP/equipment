									...
									<div class="row">
										...
										<div class="col-xs-12">
											<div class="form-group">
												...
												<input type="text" id="username" name="username" value="<?php echo $username; ?>" class="form-control" autocomplete="off" required />
											</div>
										</div>
										<div class="col-xs-12">
											<div class="form-group">
												<label for="id">Email</label>
												<input type="email" id="email" name="email" value="<?php echo $email; ?>" class="form-control" autocomplete="off" required />
											</div>
										</div>
										<div class="col-xs-12">
											<div class="form-group">
