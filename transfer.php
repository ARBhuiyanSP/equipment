							...
							<div class="row">
								...
								<div class="col-xs-10">
									...
									<table width='100%'>				
										<tr>
											<td style="text-align:center"><div class="headbody">
												...
												<h3 align="center">Euipment Shifting</h3>
											</div></td>
										</tr>
									</table>
									...
									<form action="movetotransfer.php" method="post">
										...
										<button class="btn btn-success btn-block" type="submit" name="submit"> Transfer This Product</i></button>
