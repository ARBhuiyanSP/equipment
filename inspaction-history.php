            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Inspaction Report</h4>
						...
						<form action="inspaction-report.php" method="post">
							<div class="row">
									...
									<div class="form-group">
										<div class="col-md-12">
										   ...
										   <select name="id" class="form-control select2">
												...
												<?php
												$sqlvs="SELECT * FROM `inspaction` group by `assets_id` ";
												$resultvs = mysqli_query($db,$sqlvs);
												while($rowvs = mysqli_fetch_array($resultvs)) {
												?>
												<option value="<?php echo $rowvs['assets_id'] ?>"><?php echo $rowvs['assets_id'] ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
