								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										<div class="col-md-12">
										   ...
										   <select name="id" class="form-control select2">
												...
												<?php
												$sqlvs="SELECT * FROM `assets` where `status` != 'disposed' and assign_status != 'assigned' ";
												$resultvs = mysqli_query($db,$sqlvs);
												while($rowvs = mysqli_fetch_array($resultvs)) {
												?>
												<option value="<?php echo $rowvs['id'] ?>"><?php echo $rowvs['eel_code'] ?> || <?php echo $rowvs['name'] ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
									  <div class="col-md-offset-5">
											...
											<input type="button" name="back" id="back" class="btn btn-info" onclick="location.href = 'assign-list.php';" value="Back To Assign List" />
									   </div>
									</div>
								</div>			
							</div>
