...
$output .= '<table width="100%" border="0" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><img src="images/logoMenu.png" /><br><b>Saif Powertec Ltd</b><br><span>92, Bir Uttam AK Khandakar Road<br>Mohakhali C/A, Dhaka</span></td>
	</tr>
	<tr>
	<td colspan="2">
...
$output .= '
	...
	<a href="http://localhost/equipment_raw/maintanence_list.php" style="float:right"><img src="images/spl.png" /></a>';
